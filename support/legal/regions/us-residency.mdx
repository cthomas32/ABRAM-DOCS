...
sidebarTitle: "US"
description: "Demo notes covering US data residency, hosting region selection, FedRAMP-style considerations, and data handling commitments for US-based workspaces."
---
