...
description: "Tour the sidebar, command palette, header actions, and settings panels so you can navigate the workspace quickly and find features when you need them."
---
