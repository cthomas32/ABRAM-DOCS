...
description: "Model conditional paths in workflows with if/else branches, route runs based on field values, and merge parallel branches back into a single flow."
---
