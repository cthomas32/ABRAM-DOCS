...
description: "Use idempotency keys to make automation safe under retries—deduplicate requests, avoid double charges, and recover cleanly after partial failures."
---
