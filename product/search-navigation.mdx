...
sidebarTitle: "Search"
description: "Find projects, documents, automation runs, and people quickly using full-text search, scoped filters, recent items, and keyboard navigation shortcuts."
---
