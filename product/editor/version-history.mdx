...
description: "Browse the change history of any document, compare two versions side by side, see who edited what, and restore an earlier version when needed."
---
