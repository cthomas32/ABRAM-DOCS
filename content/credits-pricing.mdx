...
| **Solo Pro** | $34/mo | 1 seat | Unlimited | 600 / mo | 10 GB | Brief parser, calendar sync, PDF exports, 5 client portals, 1 active custom intake form |
| **Team** | $39/seat/mo | 2 - 5 seats | Unlimited | 500 / seat / mo | 10 GB | Team collaboration, 15 client portals, 3 active custom intake forms |
| **Studio** | $49/seat/mo | 6 - 20 seats | Unlimited | 1,000 / seat / mo | 15 GB | Barcode scanning, 50 client portals, unlimited active intake forms |
| **Enterprise** | Custom | Starts at 21 seats + | Unlimited | Custom | Custom | Custom app flavors & builds, SSO/SCIM, unlimited client portals & active intake forms |
