...
* **Saved Role Estimates**: Once the AI estimates hours for a work package, the results are saved to the project's deliverables. Rerunning matches reads from this cache, costing **0 credits**.
