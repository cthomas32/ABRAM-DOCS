...
2. **Skills Tab**: Click **Add Skill** to add technical or creative capabilities (e.g., *Premiere Pro*, *Steadicam Operation*). Set your proficiency level: **Beginner**, **Intermediate**, **Advanced**, or **Expert**.
3. **Specializations Tab**: Declare high-level areas of focus (e.g., *Documentary Sound Mixing*).
4. **Competency Tab**: The evidence-backed view of the same skills. ABRAM counts the hours you have actually logged against each skill and shows a strength of **Beginner**, **Intermediate**, **Advanced**, or **Expert**. You do not set this yourself — it is built from completed work, and a skill you have not used in a long time cools off. This view is private to you.
5. **Growth Tab**: What changed since last week, and what is close to moving up.
6. **On-Site Preferences**: Set your Travel Radius (in miles) and Work Mode (Remote, Hybrid, or On-Site).
