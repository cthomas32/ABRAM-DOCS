...
description: Set up your agency or studio workspace, manage team permissions, configure Enterprise SSO and SCIM, and build custom project intake pipelines on ABRAM.
---
