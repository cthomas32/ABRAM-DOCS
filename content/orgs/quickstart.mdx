...
description: Set up your agency or studio workspace, manage team member permissions, configure Enterprise SSO/SCIM, set operational logistics, and build project intake pipelines.
---
...
* **Team Management** (`can_manage_team`): Invite, edit, or remove teammates.
* **Financial Access** (`can_view_financials`): View project budgets, freelancer contract rates, and invoices.
* **Financial Management** (`can_manage_finances`): Create, edit, and capture project invoices.
* **Org Profile Management** (`can_manage_org_profile`): Manage branding assets, banners, and logos.
* **Resource Management** (`can_manage_resources`): Edit equipment catalogs, schedule logistics, and log kit details.
* **Internal Project Requests** (`can_view_internal_requests`): Configure request intake forms and approve requests.
