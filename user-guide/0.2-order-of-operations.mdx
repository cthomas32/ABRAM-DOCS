...
* **External Calendars**: ABRAM publishes your bookings and holds as a private calendar link that any calendar app can subscribe to, so your ABRAM schedule appears next to the rest of your commitments. You can also subscribe ABRAM to an outside calendar, and those events show up as clash warnings without changing your availability.
