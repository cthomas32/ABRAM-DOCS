...
2. Click **New Project** in the upper right.
   > [!NOTE]
   > If your plan is at its active-project limit (the Free plan allows 2 active projects), the New Project options are replaced with an **Upgrade Required** prompt. Upgrading your plan restores access to creating additional projects.
