...
* **Local Read-Only Lock:** Local editing of names, roles, organization memberships, and granular permissions is disabled in ABRAM for members added via directory sync. Any changes must be made in the corporate identity provider dashboard; they will sync to ABRAM within seconds.
