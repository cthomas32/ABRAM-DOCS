...
> [!NOTE]
> If your organization is already at its plan's active-project limit (for example, the Free plan's limit of 2 active projects), the intake screen is replaced by an upgrade prompt instead.
