---
title: 'Section 4.2: AI Matchmaking Suggestions'
sidebarTitle: AI Matchmaking Suggestions
description: >-
  ABRAM features an advanced, AI-powered project matchmaking system designed to
  suggest the optimal crew members for your projects. Instead of searching a...
keywords:
  - ABRAM
  - ABRAM Network
  - milestone
...
<StageFlowchart stages={[
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "alloc", title: "Effort Hours Allocation", description: "Hours evaluated using priority hierarchy chain", icon: "Clock", type: "warning", badge: "HOURS GATE" }
    ]
  },
  {
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "invite", title: "Create Hold and Invite", description: "Dispatch invitations and block capacity holds", icon: "Send", type: "success", badge: "TERMINAL" }
    ]
  }
]} />
...
* **Deliverable Explicit Allocations (Priority 1 - Free)**: The system first checks the deliverables linked to the work package. If you have explicitly assigned hours to specific roles within those deliverables (e.g., *Editor: 15 hours*, *Colorist: 5 hours*), the system sums these amounts. This is the source of truth, is completely free, and does not consume AI credits.
...
* **Long Projects (more than 1 week)**: The weekly capacity hold divides total hours by total weeks:
  `Weekly Capacity Hold = Math.round(Total Effort Hours / Total Project Weeks)`
...
* *Note: The overall matchmaking score is strictly capped at 100 points, even with bonuses.*
...
* **AI Processing**: The system uses estimation engines for matchmaking calculations and advanced analysis engines for detailed brief review. Billing is based on the volume of data analyzed, where 1 Credit = $0.01.
