---
title: "Work orders and crew agreements"
description: "Use ABRAM work orders to book crew and equipment with set rates, dates, locations, and statuses—the contract layer inside each project work package."
---
...
```
[Draft Work Order] ──> [Send Invitations] ──> [Freelancer Accepts] ──> [Confirmed Booking]
                                                      │
                                                      └──> [Rejects] ──> [Re-Staffing Required]
```
