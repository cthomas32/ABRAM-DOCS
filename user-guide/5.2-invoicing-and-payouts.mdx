---
title: 'Section 5.2: Invoicing and Payouts'
sidebarTitle: Invoicing and Payouts
description: >-
  This guide covers the lifecycle of generating invoices, managing producer
  checkout authorizations, approving Purchase Orders (POs), and tracking
  payouts...
keywords:
  - ABRAM
  - ABRAM Network
