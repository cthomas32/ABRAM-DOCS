...
* **Solo Pro ($34/mo)**: Unlocks 600 monthly credits, PDF call sheet exports, Google/Outlook calendar sync, AI brief parser, 5 client portals, 1 active custom intake form, and 10 GB workspace storage.
