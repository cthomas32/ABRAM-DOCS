---
title: 'Section 4.1: Internal Talent Search'
sidebarTitle: Internal Talent Search
description: >-
  In the current Management Phase, the marketplace-wide public talent directory
  ("Discover") is disabled. Instead, ABRAM operates as an internal productio...
keywords:
  - ABRAM
  - ABRAM Network
  - freelancer
