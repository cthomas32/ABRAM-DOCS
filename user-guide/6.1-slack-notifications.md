---
title: 'Slack Notifications and Workspace Integration'
sidebarTitle: Slack Notifications
description: >-
  Connect your Slack workspace to ABRAM for real-time project, RSVP, and
  invoice notifications, channel routing, and producer mention alerts.
keywords:
  - ABRAM
  - ABRAM Network
  - milestone
