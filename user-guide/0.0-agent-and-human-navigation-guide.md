...
* **Capacity Simulations**: Chatbots can run simulation requests via the capacity impact simulation tool to forecast overbookings and calculate projected utilization before booking.
