---
title: "Work packages and payment milestones"
description: "Organize ABRAM projects into work packages and milestones—define disciplines, budgets, sequence order, and statuses tied to payment release checkpoints."
---
...
```
 planning ──> matching ──> staffed ──> in_progress ──> completed
    │            │          │             │
    └────────────┴──────────┴─────────────┴──> cancelled (Terminal)
```
