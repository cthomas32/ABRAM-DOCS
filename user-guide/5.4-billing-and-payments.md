---
title: "Producer billing and payment methods"
description: "Set up producer payment methods in ABRAM—add cards or bank accounts, fund project milestones, and manage Stripe holds and payment authorizations."
---
...
## 3. Stripe Authorization Holds (7-Day Limit)

Stripe credit card authorizations have a strict **7-day expiration limit**. If your project milestone takes longer than 7 days to complete, the hold will naturally expire.

### How ABRAM Handles Long Timelines:
* **Automatic Re-Authorization**: For work packages scheduled to take longer than 7 days, ABRAM's billing engine automatically sends a silent re-authorization request to Stripe on day 6 to refresh the hold.
* **Hold Release**: If a project is cancelled or a milestone is rejected by the producer, the authorization hold is released immediately. The funds are returned to the producer's available credit line, and no charge is processed.
