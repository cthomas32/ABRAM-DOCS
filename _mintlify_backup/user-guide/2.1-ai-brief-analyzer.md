---
title: "AI brief analyzer (Brief Intelligence)"
description: "Use ABRAM's Brief Intelligence to upload or type a creative brief and auto-generate work packages, roles, deliverables, schedules, and crew matches."
---
...
1. **Dynamic Clarifying Questions**: The AI generates 3 to 5 highly specific, open-ended questions designed to fill in missing details. For example:
   - _"What is the expected final runtime of the video deliverables?"_
   - _"Are travel and lodging expenses covered under the estimated budget?"_
   - _"Do you require the editor to be local to Los Angeles for in-person review sessions?"_
...
1. **Priority 1: Deliverable Explicit Allocations (Free)** The system first checks the deliverables you or the AI defined for the work package. If you have explicitly assigned hours to specific roles within those deliverables (e.g., _Cinematographer: 20 hours_, _Editor: 10 hours_), the system sums these amounts. This is the source of truth, is completely free, and does not consume AI credits.
2. **Priority 2: AI Estimation (Credit Gated)** If no explicit allocations are defined, but you have set an overall estimate for the work package, the AI engine analyzes the scope and estimates how those hours should be split among the active roles (for instance, projecting that a 30-hour project needs 18 hours of shooting and 12 hours of editing).
3. **Priority 3: Even Split Fallback** If the AI estimation cannot run (due to network issues or insufficient organization credits), the system falls back to a fair, simple division. It divides the total work package hours evenly among the required roles (e.g., 30 hours split among 3 roles gets 10 hours each).
