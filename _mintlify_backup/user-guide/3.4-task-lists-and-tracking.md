---
title: "Task lists and project tracking"
description: "Track ABRAM deliverables, milestones, and work orders from the unified Tasks tab with search, status filters, and assignee-based progress reporting."
---
...
Project Managers can click **Add Task** or select the edit pencil icon on any item to open the configuration dialogs:
...
### Work Order Modal
* Configure schedule dates, times, crew members, and equipment lists. (See [Section 3.3](/user-guide/3.3-work-orders-and-agreements) for details).
