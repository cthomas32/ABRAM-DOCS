...
*Note: All scores are capped at a maximum of 100 points. The interface lists specific **Match Reasonings** (strengths) and **Concerns / Red Flags** (such as rate limits or calendar conflicts) under each candidate.*
