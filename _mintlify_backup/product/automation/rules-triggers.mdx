...
description: "Define when automation runs using events, filters, and guardrails—match conditions precisely so workflows fire only on the changes you care about."
---
