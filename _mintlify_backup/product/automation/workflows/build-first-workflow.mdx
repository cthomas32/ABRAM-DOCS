...
description: "Follow a step-by-step tutorial to build a simple approval workflow from scratch, wire up a trigger, add branches, and publish your first automation."
---
