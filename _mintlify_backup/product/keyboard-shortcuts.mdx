...
description: "Speed up navigation, editing, and command access with keyboard shortcuts for the sidebar, command palette, editor, and global actions across the app."
---
