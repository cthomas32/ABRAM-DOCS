...
const SEO = {
  title: "An AI Assistant That Runs the Platform, No MCP Required",
  description:
    "Ask for it and approve it. ABRAM answers from your live workspace, drafts your paperwork and runs multi-step work. No MCP server or API keys to set up.",
  keywords: [
