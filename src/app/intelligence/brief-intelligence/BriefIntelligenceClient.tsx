      ...
      <main className="text-zinc-100 overflow-x-hidden pt-24 pb-20 select-none relative z-10 isolate">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 md:mb-12">
          ...
          >
            ...
            >
              Paste a brief and get a structured Work Breakdown Structure instantly.
            </motion.p>
          </motion.div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed font-sans">
                  Instantly transform unstructured PDF or text briefs into standard production structures.
                </p>
              </div>
              ...
              <div className="flex flex-col space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed font-sans">
                  Answer quick clarifying questions to boost scoping confidence before you hire.
                </p>
              </div>
              ...
              <div className="flex flex-col space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed font-sans">
                  Parsed work packages map directly to contractor skills for fast matchmaking.
                </p>
              </div>
