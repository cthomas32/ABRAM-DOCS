  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        id: "sequences",
        label: "Sequences",
        href: "/admin/dashboard/sequences",
        icon: Route,
        hint: "Ordered follow ups, enrolled by hand",
        permission: "crm.sequences.manage",
        keywords: ["cadence", "steps", "nurture", "enrol", "enroll"],
      },
      {
        id: "lists",
        label: "Lists",
        ...
        icon: ListFilter,
        hint: "Saved filters over people",
        permission: "crm.contacts.read.own",
        keywords: ["segments", "saved views", "filters", "export"],
      },
      {
        id: "registrations",
        label: "Registrations",
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        icon: BarChart3,
        hint: "Pipeline, forecast, activity and commission",
        permission: "reports.read",
        keywords: ["forecast", "pipeline", "activity", "funnel", "by rep"],
      },
      {
        id: "revenue",
        label: "Revenue",
