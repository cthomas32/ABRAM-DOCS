...
import type { Notify } from "@/lib/crm/console";
...
const ORIGINS: Record<string, { href: string; label: string }> = {
  codes: { href: "/admin/dashboard/people?tab=codes", label: "Codes" },
  card: { href: "/admin/dashboard/people?tab=card", label: "Your card" },
};

const FALLBACK_ORIGIN = { href: "/admin/dashboard/people", label: "Contacts" };
