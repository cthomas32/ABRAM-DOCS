...
import { downloadFile, formatDateTime, randomCode, ratePct, type Notify } from "@/lib/crm/console";
      ...
      {creating && (
        <div className="glass-panel rounded-2xl border-white/8 p-4 sm:p-5 space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              <span className="block text-xs uppercase font-bold tracking-widest text-zinc-400 mb-1.5">
                Code
              </span>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="min-w-0 flex-1 space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              href={`/admin/dashboard/people/design?k=${encodeURIComponent(code.code)}&from=codes`}
            ...
            <Link
              href={`/admin/dashboard/people/print?k=${encodeURIComponent(code.code)}`}
              className="btn-glass px-3.5 min-h-[44px] sm:min-h-[36px] text-[11px] font-medium rounded-full"
            >
...
function Stat({ label, value }: { label: string; value: number | string }) {
  return (
    <div className="rounded-lg border border-white/5 bg-white/[0.02] px-2.5 py-2">
      <span className="block text-xs uppercase font-bold tracking-widest text-zinc-400 font-sans">
        {label}
      </span>
