...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: {
      ...
      capacity_planning: false,
      conflict_alerts: "Booking Conflicts Only",
      external_invites: "Up to 5 / project",
      open_crew_slots: true,
      file_sharing: true,
      callsheet_pdf_export: false,
      callsheet_email_distribution: false,
    ...
    marketingFeatures: [
      ...
      "View-only Advanced Scheduling Access",
      "3 Workspace Locations",
      "Track up to 5 external contractors",
  ...
  },
  {
    ...
    features: {
      ...
      capacity_planning: false,
      conflict_alerts: "Advanced Conflict Alerts",
      external_invites: "Up to 15 / project",
      open_crew_slots: true,
      file_sharing: true,
    ...
    marketingFeatures: [
      ...
      "Track up to 15 external contractors",
