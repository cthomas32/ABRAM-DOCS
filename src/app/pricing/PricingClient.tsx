...
const FEATURES_SCHEMA: Category[] = [
  {
    ...
    features: [
      ...
      { id: "workspace_locations", name: "Workspace Locations" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "timecard_approval", name: "Timecard Submit & Approval Workflow" },
      { id: "calendar_sync", name: "Published & Subscribed Calendars" },
      ...
      { id: "external_invites", name: "External Crew per Project" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "callsheet_pdf_export", name: "Call Sheet PDF Exports" },
...
const PLANS: Plan[] = [
  {
    ...
    audience: "Get your first production organized.",
    tagline: "Free to start · no card required",
    features: {
      ...
      integrated_timesheets: false,
      timecard_approval: false,
      calendar_sync: false,
      talent_search: false,
      ai_matchmaking: false,
      ai_talent_search: false,
      capacity_planning: false,
      conflict_alerts: true,
      external_invites: "3 / project · 5 total roster",
      open_crew_slots: true,
      file_sharing: true,
      callsheet_pdf_export: "Watermarked PDF",
      callsheet_email_distribution: false,
      asset_approvals: false,
  ...
  },
  {
    ...
    tagline: "Everything to run up to 3 projects",
    features: {
      workspace_storage: "3 GB",
      workspace_locations: "3",
      active_projects: "Up to 3",
      interactive_scheduler: "Read-Only",
      barcode_scanning: false,
      audit_logs_viewer: false,
      team_permissions: false,
  ...
  },
  {
    ...
    features: {
      ...
      capacity_planning: false,
      conflict_alerts: true,
      external_invites: "25 / project",
      open_crew_slots: true,
      file_sharing: true,
      callsheet_pdf_export: "Watermark-free PDF",
...
const FEATURE_DESCRIPTIONS: Record<string, string> = {
  ...
  workspace_locations: "Physical locations for multi-site resource management — each location groups the equipment and resources stored there.",
  ...
  timecard_approval: "Formal submit-and-approve workflow for timecards, with an approvals inbox for managers. Enterprise only.",
  calendar_sync: "Publish your ABRAM bookings as a private calendar link, and subscribe to an outside calendar to see clashes against your schedule.",
  ...
  conflict_alerts: "Real-time warnings for double-bookings, over-allocation, and scheduling overlaps across crew and gear. The same alerting on every plan — there is no tiered version.",
  external_invites: "Invite external crew or agency contractors onto a project roster without giving them a full workspace seat. Free is capped at 3 external crew per project and 5 across your whole roster; Solo Lite at 10 per project; Solo Pro at 25 per project; Team and above are uncapped.",
  ...
  callsheet_pdf_export: "Export print-ready PDF call sheets and summaries. Free and Solo Lite exports carry an ABRAM watermark; Solo Pro and above export watermark-free.",
  ...
  invoicing: "Generate professional invoices from tracked expenses and rates, with direct Stripe payouts. Free plans can issue 3 invoices per month, Solo Lite 10, and every paid tier above is unlimited.",
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col gap-16 md:gap-24 relative z-10">
        ...
        <section className="flex flex-col gap-8">
          ...
          <div className="md:hidden flex items-center justify-between gap-1.5 text-xs text-zinc-500 bg-zinc-950/40 border border-white/5 py-2.5 px-3.5 rounded-xl">
            ...
            <div className="flex items-center gap-1">
              <span>←</span> Swipe to scroll <span>→</span>
            </div>
          </div>
