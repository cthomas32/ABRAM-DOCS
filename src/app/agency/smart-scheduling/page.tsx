...
export const metadata: Metadata = {
  ...
  description: 'Coordinate resources, locations, and crew schedules in an interactive timeline. Resolve conflicts and compliance using smart creative operations tools.',
  keywords: [
