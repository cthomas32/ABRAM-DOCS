...
export const metadata: Metadata = {
  ...
  description: 'Manage crew rosters and production assets. Use our creative operations platform to coordinate teams, track equipment, and optimize allocations.',
  keywords: [
