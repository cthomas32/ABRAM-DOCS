...
function getIndexContent() {
  ...
  const indexPath = path.join(process.cwd(), "index.mdx");
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  let title = doc.data.title || "Welcome to the Help Center";
  ...
  const canonicalUrl = `https://docs.abram.network/docs`;
...
export default async function DocsIndexPage() {
  ...
  // 1. Resolve Title
  const title = doc.data.title || "Welcome to the Help Center";
