...
description: "Install the Salesforce connector, authenticate with OAuth, and map standard or custom objects—accounts, opportunities, leads—into platform records."
---
