...
description: "Connect HubSpot CRM to sync deals, contacts, and company records, map custom properties to platform fields, and trigger automation from pipeline changes."
---
