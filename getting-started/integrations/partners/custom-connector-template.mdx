...
description: "Fork the reference connector template to build a private integration faster, with auth scaffolding, webhook handlers, and example field mappings."
---
