...
description: "Subscribe to platform events, verify webhook signatures with a shared secret, and handle retries with idempotency keys to avoid duplicate processing."
---
