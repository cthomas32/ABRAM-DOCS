...
description: "Register an OAuth client, configure scopes and redirect URLs, and use the authorization-code flow to let third-party apps access the platform safely."
---
