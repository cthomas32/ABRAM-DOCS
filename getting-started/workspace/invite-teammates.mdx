...
description: "Send email or link invitations to teammates, assign their starting roles, set permissions, and track pending or expired invites from one screen."
---
